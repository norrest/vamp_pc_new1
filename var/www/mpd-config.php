...
// priority
$_mpd_select['priority'] .= "<option value=\"FIFO:80\" ".(($_mpd['priority'] == 'FIFO:80') ? "selected" : "")." >FIFO:80</option>\n";	
$_mpd_select['priority'] .= "<option value=\"FIFO:85\" ".(($_mpd['priority'] == 'FIFO:85') ? "selected" : "")." >FIFO:85</option>\n"; 
$_mpd_select['priority'] .= "<option value=\"FIFO:90\" ".(($_mpd['priority'] == 'FIFO:90') ? "selected" : "")." >FIFO:90</option>\n"; 
$_mpd_select['priority'] .= "<option value=\"FIFO:99\" ".(($_mpd['priority'] == 'FIFO:99') ? "selected" : "")." >FIFO:99</option>\n"; 
...
$_mpd_select['buffer_before_play'] .= "<option value=\"40%\" ".(($_mpd['buffer_before_play'] == '40%') ? "selected" : "")." >40%</option>\n";	
$_mpd_select['buffer_before_play'] .= "<option value=\"50%\" ".(($_mpd['buffer_before_play'] == '50%') ? "selected" : "")." >50%</option>\n";	
$_mpd_select['buffer_before_play'] .= "<option value=\"60%\" ".(($_mpd['buffer_before_play'] == '60%') ? "selected" : "")." >60%</option>\n";	

//samplerate_converter
$_mpd_select['samplerate_converter'] .= "<option value=\"soxr high\" ".(($_mpd['samplerate_converter'] == 'soxr high') ? "selected" : "")." >soxr high</option>\n";	
$_mpd_select['samplerate_converter'] .= "<option value=\"soxr medium\" ".(($_mpd['samplerate_converter'] == 'soxr medium') ? "selected" : "")." >soxr medium</option>\n";
$_mpd_select['samplerate_converter'] .= "<option value=\"soxr low\" ".(($_mpd['samplerate_converter'] == 'soxr low') ? "selected" : "")." >soxr low</option>\n";
...
$_mpd_select['audio_output_format'] .= "<option value=\"192000:16:2\" ".(($_mpd['audio_output_format'] == '192000:16:2') ? "selected" : "").">16 bit / 192 khz</option>\n";
$_mpd_select['audio_output_format'] .= "<option value=\"352800:16:2\" ".(($_mpd['audio_output_format'] == '352800:16:2') ? "selected" : "").">16 bit / 352.8 khz</option>\n";
$_mpd_select['audio_output_format'] .= "<option value=\"384000:16:2\" ".(($_mpd['audio_output_format'] == '384000:16:2') ? "selected" : "").">16 bit / 384 khz</option>\n";
...
$_mpd_select['audio_output_format'] .= "<option value=\"352800:24:2\" ".(($_mpd['audio_output_format'] == '352800:24:2') ? "selected" : "").">24 bit / 352.8 khz</option>\n";
$_mpd_select['audio_output_format'] .= "<option value=\"384000:24:2\" ".(($_mpd['audio_output_format'] == '384000:24:2') ? "selected" : "").">24 bit / 384 khz</option>\n";
