...
<form class="form-horizontal" action="" method="post">
	<div id="service-menu-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="service-menu-modal" aria-hidden="true">
		...
		<div class="modal-body">
			...
			<button id="install-mDNS" name="mDNS add" formtarget="_blank" formaction="apple.php" class="btn btn-primary btn-large btn-block"><i class=""></i> Install mDNS fop Apple Router </button>
